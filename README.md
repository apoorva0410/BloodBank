...
3. Download project from github(https://github.com/apoorva0410/Blood-Bank-And-Donation-Management-System.git).

   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/apoorva0410/Blood-Bank-And-Donation-Management-System.git
